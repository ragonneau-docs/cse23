...
\begin{frame}{A crucial difficulty in the implementation}
    \begin{itemize}
        ...
        \textcolor{FernGreen}{A well-known approach: using a geometry-improving mechanism.\footnote{\textcite{Conn_Scheinberg_Vicente_2008a,Conn_Scheinberg_Vicente_2008b}, \textcite{Fasano_Morales_Nocedal_2009}, \dots}}
    \end{itemize}
