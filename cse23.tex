...
\begin{frame}{Conclusion}
    ...
    COBYQA already received \alert{positive} feedback from practitioners.

    \medskip

    \begin{block}{Dr.\ Gallard (leader of the MDO team at IRT Saint-Exup{\'{e}}ry, France)}
        \begin{quoting}
            \small%
    ...
    COBYQA will soon be included in
    \begin{itemize}
